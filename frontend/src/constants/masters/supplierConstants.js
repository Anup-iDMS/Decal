...
//all master data for SUPPLIER Master Screen
export const SUPPLIER_MASTER_LIST_REQUEST = 'SUPPLIER_MASTER_LIST_REQUEST'
export const SUPPLIER_MASTER_LIST_SUCCESS = 'SUPPLIER_MASTER_LIST_SUCCESS'
export const SUPPLIER_MASTER_LIST_FAIL = 'SUPPLIER_MASTER_LIST_FAIL'
export const SUPPLIER_MASTER_LIST_RESET = 'SUPPLIER_MASTER_LIST_RESET'
