...
//all master data for Customer Master Screen
export const CUSTOMER_MASTER_LIST_REQUEST = 'CUSTOMER_MASTER_LIST_REQUEST'
export const CUSTOMER_MASTER_LIST_SUCCESS = 'CUSTOMER_MASTER_LIST_SUCCESS'
export const CUSTOMER_MASTER_LIST_FAIL = 'CUSTOMER_MASTER_LIST_FAIL'
export const CUSTOMER_MASTER_LIST_RESET = 'CUSTOMER_MASTER_LIST_RESET'