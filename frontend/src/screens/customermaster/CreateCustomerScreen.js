...
import { createCustomer, getAllMasterDataForCustomerMaster } from '../../actions/masters/customerActions'
...
const CreateCustomerScreen = ({ match, history }) => {
   ...
   const masterdataForCustomerMaster = useSelector((state) => state.masterdataForCustomerMaster)
   ...
   if(masterdataForCustomerMaster !== undefined) {
      autoIncrementedCustomerNo = masterdataForCustomerMaster.autoIncrementedCustomerNo;
   }
   ...
   useEffect(() => {
      ...
      if (success) {
         ...
         NotificationManager.success(`Customer Record ${customer.custName} has been successfully created !`, 'Successful!', APPLICATION_NOTIFICATION_TIME_OUT);
		}
      console.log("Error in useEffect is ", error)
      if(error) {
         dispatch({ type: CUSTOMER_CREATE_RESET })
         NotificationManager.error(`Error in creating Customer Master Record !`, 'Error!', APPLICATION_NOTIFICATION_TIME_OUT);
      }
      window.scrollTo(0, 0)
   ...
   return (
      <FormContainer>
         ...
         <FormFieldsContainer frameTitle = "Add Customer Details !!!" >
            {error && <Row><Col lg={4}></Col><Col lg={4}><Message variant='danger'>{error} !!</Message></Col></Row>}
               ...
               <Col>
                  <Row>
                     ...
                     <Col lg={4} md={12} xs={12}>
                        <Form.Group controlId='custName'>
                           <Form.Label>Customer Name (Legal Entity)<span className="mandatory">*</span></Form.Label>
                           <Form.Control
                              type='text'
                              placeholder=''
                              required
                     ...
                     <Col lg={4} md={12} xs={12}>
                        <Form.Group controlId='custCode'>
                           <Form.Label>Customer Nick Name<span className="mandatory">*</span></Form.Label>
                           <Form.Control
                              type='text'
                              placeholder=''
                              required
                  ...
                  <Row>
                     <Col lg={4} md={12} xs={12}>
                        ...
                        <Form.Label>Type of Company<span className="mandatory">*</span></Form.Label>
                        <Form.Control
                           as='select'
                           custom
                  ...
                  <Row>
                     <Col lg={4} md={12} xs={12}>
                        ...
                        <Form.Label>Goods and Services Tax(GST)<span className="mandatory">*</span></Form.Label>
                        <Form.Control
                           type='text'
                           placeholder=''
                           required
                     ...
                     <Col lg={4} md={12} xs={12}>
                        <Form.Group controlId='custPAN'>
                           <Form.Label>Permanent Account Number(PAN)<span className="mandatory">*</span></Form.Label>
                           <Form.Control
                              type='text'
                              placeholder=''
                              required
                  ...
                  <Row>
                     <Col lg={6} md={12} xs={12}>
                        <Row>
                           <Col><h6 className="px-3 py-2">Address(Bill To)</h6></Col>
                           <Col style={{textAlign:"end"}}>
                              <Button variant="primary" className="button-class btn-md" onClick={handleBillAddressCopy}>Copy Billing Address</Button>
                           </Col>
                        </Row>
                        <Row className="my-2">
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custBillAddressLine1'>
                                 <Form.Label>Billing Address Line 1<span className="mandatory">*</span></Form.Label>
                                 <Form.Control
                                    type='text'
                                    placeholder=''
                                    required
                                    value={custBillAddressLine1}
                                    onChange={(e) => setCustBillAddressLine1(e.target.value)}
                                 ></Form.Control>
                              </Form.Group>
                           </Col>
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custBillAddressLine2'>
                                 <Form.Label>Billing Address Line 2<span className="mandatory">*</span></Form.Label>
                                 <Form.Control
                                    type='text'
                                    placeholder=''
                                    required
                                    value={custBillAddressLine2}
                                    onChange={(e) => setCustBillAddressLine2(e.target.value)}
                                 ></Form.Control>
                              </Form.Group>
                           </Col>
                        </Row>
                           ...
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custBillAddressLine3'>
                                 ...
                                 <Form.Control
                                    ...
                                    onChange={(e) => setCustBillAddressLine3(e.target.value)}
                                 ></Form.Control>
                              </Form.Group>
                           </Col>
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custBillState'>
                                 <Form.Label>State - Place of Supply<span className="mandatory">*</span></Form.Label>
                                 <Form.Control
                                    type='text'
                                    placeholder=''
                                    required
                        ...
                        <Row>
                           <Col lg={4} md={12} xs={12}>
                              <Form.Group controlId='custBillCity'>
                                 <Form.Label>City<span className="mandatory">*</span></Form.Label>
                                 <Form.Control
                                    type='text'
                                    placeholder=''
                                    required
                     ...
                     <Col lg={6} md={12} xs={12} style={{borderLeft: "2px solid red"}}>
                        <Row>
                           <Col><h6 className="px-3 py-2">Address(Ship To)</h6></Col>
                           <Col style={{textAlign:"end"}}>
                              <Button variant="primary" className="button-class btn-md" onClick={handleClearShipAddressCopy}>Clear Shipping Address</Button>
                           </Col>
                        </Row>
                        <Row className="my-2">
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custShipAddressLine1'>
                                 <Form.Label>Shipping Address Line 1<span className="mandatory">*</span></Form.Label>
                                 <Form.Control
                                    type='text'
                                    placeholder=''
                                    required
                                    value={custShipAddressLine1}
                                    onChange={(e) => setCustShipAddressLine1(e.target.value)}
                                 ></Form.Control>
                              </Form.Group>
                           </Col>
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custShipAddressLine2'>
                                 <Form.Label>Shipping Address Line 2<span className="mandatory">*</span></Form.Label>
                                 <Form.Control
                                    type='text'
                                    placeholder=''
                                    required
                                    value={custShipAddressLine2}
                                    onChange={(e) => setCustShipAddressLine2(e.target.value)}
                                 ></Form.Control>
                              </Form.Group>
                           </Col>
                        </Row>
                           ...
                           <Col lg={6} md={12} xs={12}>
                              <Form.Group controlId='custShipAddressLine3'>
                                 ...
                                 <Form.Control
                                    ...
                                    onChange={(e) => setCustShipAddressLine3(e.target.value)}
                                 ></Form.Control>
                              </Form.Group>
                           </Col>
                           <Col lg={6} md={12} xs={12}>
